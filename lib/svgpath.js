...
//
SVGPath.prototype.toArray = function () {
  this.doTransform().round(this.precision);
  return this.segments.concat.apply([], this.segments);
};
...
//  - zip : boolean (if not set use SVGPath.prototype.normalize_before_tostring)
//
SVGPath.prototype.toString = function (format, normalize) {
